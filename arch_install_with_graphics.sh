...
arch-chroot /mnt pacman -S xorg-server xorg-xinit xorg-apps mesa-libgl xterm xf86-video-vesa cinnamon file-roller gvfs-smb samba cifs-utils sddm firefox mc chromium alsa-utils htop screenfetch --noconfirm
